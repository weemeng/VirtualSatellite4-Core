...
public class ReqIFNature implements IProjectNature {
	...
	public static final String NATURE_ID = "de.dlr.sc.virsat.model.extension.requirements.reqif.builder.ReqIFNature";
	 ...
	 */
	private boolean hasReqIFBuilder() throws CoreException {
	...
	private void addBuilder() throws CoreException {
		...
		command.setBuilderName(BUILDER_ID); // attach it to builder
