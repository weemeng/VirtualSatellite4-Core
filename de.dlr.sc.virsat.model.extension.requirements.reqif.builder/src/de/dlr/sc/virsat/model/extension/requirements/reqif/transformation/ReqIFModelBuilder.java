...
public class ReqIFModelBuilder {
	 ...
	 * 
	 * @param typeElementProvider
	 *            a class that provides ElementTypes by their ID
	 */
	...
	public Specification createSpecification(RequirementsSpecification conceptSpecification) {
		...
		specification.setType((SpecificationType) typeElementProvider.getElementById(conceptSpecification.getUuid()));
	...
	/**
	 * Create a reqif attribute definition from a requirement concept requirement
	 * attribute
	 * 
	 * @param conceptAtt
	 ...
	 * 
	 * @param conceptAttributeValue
	 *            the concept AttributeValue
	 * @return the reqif attribute value
	 */
	public AttributeValue createAttributeValue(
			de.dlr.sc.virsat.model.extension.requirements.model.AttributeValue conceptAttributeValue) {
		...
		switch (attType.getType()) {
			case RequirementAttribute.TYPE_String_NAME:
				...
				valueElementString
						.setDefinition((AttributeDefinitionString) typeElementProvider.getElementById(attType.getUuid()));
			...
			case RequirementAttribute.TYPE_Boolean_NAME:
				...
				valueElementBoolean
						.setDefinition((AttributeDefinitionBoolean) typeElementProvider.getElementById(attType.getUuid()));
				valueElement = valueElementBoolean;
				break;
			case RequirementAttribute.TYPE_Date_NAME:
				AttributeValueDate valueElementDate = ReqIF10Factory.eINSTANCE.createAttributeValueDate();
				valueElementDate
						.setDefinition((AttributeDefinitionDate) typeElementProvider.getElementById(attType.getUuid()));
			...
			case RequirementAttribute.TYPE_Integer_NAME:
				...
				valueElementInteger
						.setDefinition((AttributeDefinitionInteger) typeElementProvider.getElementById(attType.getUuid()));
			...
			case RequirementAttribute.TYPE_Real_NAME:
				...
				valueElementReal
						.setDefinition((AttributeDefinitionReal) typeElementProvider.getElementById(attType.getUuid()));
				valueElementReal.setTheValue(Double.parseDouble(conceptAttributeValue.getValue()));
				valueElement = valueElementReal;
				break;
			case RequirementAttribute.TYPE_Enumeration_NAME:
				AttributeValueEnumeration valueElementEnumeration = ReqIF10Factory.eINSTANCE
						.createAttributeValueEnumeration();
				valueElementEnumeration.setDefinition(
						(AttributeDefinitionEnumeration) typeElementProvider.getElementById(attType.getUuid()));
				// TODO set value
